                ...
                <form class='form-edit-block' name='formEditUser' action=''>
                    <div class='edit-block'>
                        ...
                        <div class='grid-column edit-input-block'>
                            <input id='name' class='edit-input' type='text' name='newsName'>
                            <input id='newsText' class='edit-input' type='text' name='newsText'>
                            <input id='date' class='edit-input' type='date' name='newsDate'>
                        </div>
                    </div>
...
<?
    ...
    if(isset($_GET['save'])) {
        $sql = "INSERT INTO `News` SET `news_heading` = ?, `news_text` = ?, `news_date` = ?";
        $insert = $pdo -> prepare($sql);
        $insert -> execute(array("$_GET[newsName]", "$_GET[newsText]", "$_GET[newsDate]"));
